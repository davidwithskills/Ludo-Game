    ...
    extend: {
      ...
      colors: {
        board: {
          ...
          safe: "hsl(var(--board-safe))",
          center: "hsl(var(--board-center))",
        },
        player: {
          red: "hsl(var(--player-red))",
          "red-soft": "hsl(var(--player-red-soft))",
          green: "hsl(var(--player-green))",
          "green-soft": "hsl(var(--player-green-soft))",
          blue: "hsl(var(--player-blue))",
          "blue-soft": "hsl(var(--player-blue-soft))",
          yellow: "hsl(var(--player-yellow))",
          "yellow-soft": "hsl(var(--player-yellow-soft))",
        },
